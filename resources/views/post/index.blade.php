                                    ...
                                    @foreach ($posts as $post)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-no-wrap text-right text-sm leading-5 font-medium">
                                                <form action="/adm-panel/post/switch/{{ $post->id }}" method="POST" class="inline-flex">
                                                    @csrf
                                                    @method('GET')
                                                    <button type="submit" title="switch"
                                                ...
                                                <a href="{{ route('post.show', $post->id) }}"
                                                   class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                                    <svg class="-ml-1 mr-2 h-5 w-5 text-blue-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
